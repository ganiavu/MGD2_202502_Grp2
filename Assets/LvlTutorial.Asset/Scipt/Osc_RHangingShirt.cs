...
public class Osc_RHangingShirt : MonoBehaviour
{
    ...
    // destroy when swipe to right script
    ...
    private IEnumerator MoveAndDestroy()
    {
        ...
        Vector3 targetPosition = new Vector3(transform.position.x + 5f, transform.position.y, transform.position.z); // Move right
